...
class CalculatorContentMobile extends StatefulWidget {

  _CalculatorContentMobile createState() {
    return _CalculatorContentMobile();
  }
}

class _CalculatorContentMobile extends State {
  int VKValue = 0;
